...
class Building_4 extends THREE.Object3D {
  constructor() {
    ...
    const buildingGeometry = new THREE.BoxGeometry( 300, 1500, 300); 
    // Cargar la textura
    const textureLoader = new THREE.TextureLoader();
    const perfil = textureLoader.load('./imgs/perfil4.jpg');
    const alzado = textureLoader.load('./imgs/alzado4.jpg');
    ...
    const geometry = new THREE.BoxGeometry(300, 1500, 300);
    ...
    this.visibleBBox.position.set(0,1500/2,0);
